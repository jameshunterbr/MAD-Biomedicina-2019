...
knitr::include_graphics("~/Documents/MAD/MAD-Biomedicina-2019/CRAN_361_initial_screen.png")
```
...
knitr::include_graphics("~/Documents/MAD/MAD-Biomedicina-2019/start_up_text.png")
```
...
knitr::include_graphics("~/Documents/MAD/MAD-Biomedicina-2019/pacotes_vector.png")
```
...
knitr::include_graphics("~/Documents/MAD/MAD-Biomedicina-2019/github_repo_biomed.png")
```
...
knitr::include_graphics("~/Documents/MAD/MAD-Biomedicina-2019/instal_pac_file.png")
```
...
knitr::include_graphics("~/Documents/MAD/MAD-Biomedicina-2019/instalar_pacotes_280719.png")
```
...
Fizemos a instalação dos softwares e a maioria dos pacotes que vamos usar durante o curso. Finalmente é a hora de usar R, que vamos fazer no próximo capítulo. Mas primeiro vamos relembrar os pontos importantes deste processo inicial:
  ...
  7.  Temos um repo no GitHub: https://github.com/jameshunterbr/MAD-Biomedicina-2019
  8.  Pode consultar meu canal no YouTube:  https://www.youtube.com/channel/UCbvgZ8RYeTtgjhAKE-jub5A
